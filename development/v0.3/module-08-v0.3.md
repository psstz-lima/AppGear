# M08 – Serviços de Aplicação Core (LiteLLM, Flowise, N8n, Directus, Appsmith, Metabase) (v0.3)

> [!IMPORTANT]
> Este documento define o **Módulo 08 (M08)** da arquitetura AppGear na linha v0.3.  
...
commonAnnotations:
  appgear.io/contract-version: "v0.3"
...
git commit -m "mod8 v0.3: core app services via Kong, FinOps labels, resources e integ. com M05"
...
5. **Teste de LiteLLM como gateway**
   ...
   kubectl -n appgear-core run litellm-chat-test --rm -it --image=curlimages/curl -- \
     curl -s http://core-litellm:4000/chat/completions \
       ...
       -d '{"model":"local-llama3","messages":[{"role":"user","content":"Teste M08 v0.3"}]}'
   ```
...
* **Documentação do módulo**:
  ...
  * Arquivo: `Módulo 08 – Serviços de Aplicação Core v0.3.md`;
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * Istio com `mTLS STRICT STRICT`, garantindo tráfego seguro entre serviços de aplicação e demais serviços core;
