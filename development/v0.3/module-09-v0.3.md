# M09 – Suíte Factory (v0.3)

> [!IMPORTANT]
> Este documento define o **Módulo 09 (M09)** da arquitetura AppGear na linha v0.3.  
...
- Factory: reforça CDEs e pipelines de dados sobre n8n/Appsmith/Directus e storage seguro do M04.
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * Istio com mTLS STRICT entre pods de Factory e serviços Core.
