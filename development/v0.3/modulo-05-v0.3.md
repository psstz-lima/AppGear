# M05 – Segurança e Segredos (Vault, OPA, Falco, OpenFGA) (v0.3)

> [!IMPORTANT]
> Este documento define o **Módulo 05 (M05)** da arquitetura AppGear na linha v0.3.  
...
- Padroniza Vault/OPA/Falco/OpenFGA como segurança compartilhada para APIs e pipelines.
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * Istio com `mTLS STRICT STRICT`, garantindo tráfego seguro para Vault, OPA e OpenFGA,
