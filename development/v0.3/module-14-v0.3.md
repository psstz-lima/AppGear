# M14 – Pipelines de Geração AI-First (v0.3)

> [!IMPORTANT]
> Este documento define o **Módulo 14 (M14)** da arquitetura AppGear na linha v0.3.  
...
- Pipeline n8n → Git → Argo Events/Workflows → Argo CD → vCluster com OPA (M05) e chaos (M12).
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * malha de serviço com mTLS STRICT STRICT usada por Argo, N8n e serviços Core;
