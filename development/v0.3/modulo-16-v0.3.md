# M16 – Conectividade Híbrida (VPN, Túneis e Acesso Remoto) (v0.3)

> [!IMPORTANT]
> Este documento define o **Módulo 16 (M16)** da arquitetura AppGear na linha v0.3.  
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * Istio (mTLS STRICT STRICT) para tráfego interno entre Operator, pods, serviços core;
