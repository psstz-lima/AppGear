# M15 – Continuidade de Negócios (DR & Backup Global) (v0.3)

> [!IMPORTANT]
> Este documento define o **Módulo 15 (M15)** da arquitetura AppGear na linha v0.3.  
...
- Backup/DR com Velero + snapshots Ceph e integração Vault/ExternalSecrets para segredos.
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * Istio com mTLS STRICT STRICT protegendo tráfego do Velero dentro do cluster;
