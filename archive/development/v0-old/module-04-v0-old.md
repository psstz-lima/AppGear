...
2. **Segurança, Continuidade e Custos (Contrato v0 – seções de Infra/DR/FinOps)**
   ...
   * **Criptografia**:
     ...
     * Em trânsito: sidecar Istio em todos os pods Core, com mTLS STRICT conforme Módulo 02.
   * **FinOps**:
...
#### 3.3 StatefulSet Postgres (resources + mTLS + backup)
...
4. **mTLS (Istio) ativo nos pods core**
...
* **Módulo 02 – Malha de Serviço e Borda (Istio, Traefik, Coraza, Kong)**
  ...
  * Fornece:
    ...
    * Istio com mTLS STRICT para o tráfego entre serviços Core e demais workloads,
