# GitOps – M11 (suite-operations)

Este diretório contém a camada GitOps/Kustomize para o módulo **M11** da AppGear (v0.3).

- Namespace alvo: `appgear-operations`
- Documento normativo do módulo: `development/v0.3/module-11-v0.3.md`
...
`iot,thingsboard,edge,rpa,digital-twins`
...
- Substituir e/ou complementar o `deployment.yaml` com os manifests reais (Deployments, CRDs, Helm charts, Argo Applications, etc.) que implementam o módulo **M11**, mantendo os labels e o padrão de namespace.
