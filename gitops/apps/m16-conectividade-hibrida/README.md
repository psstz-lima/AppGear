# GitOps – M16 (m16-conectividade-hibrida)

Este diretório contém a camada GitOps/Kustomize para o módulo **M16** da AppGear.
...
- Adicionar aqui os manifests reais (Deployments, Services, CRDs, etc.) que implementam o módulo **M16**, referenciando-os em `kustomization.yaml`.
