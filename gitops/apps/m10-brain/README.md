# GitOps – M10 (suite-brain)

Este diretório contém a camada GitOps/Kustomize para o módulo **M10** da AppGear (v0.3).

- Namespace alvo: `appgear-brain`
- Documento normativo do módulo: `development/v0.3/module-10-v0.3.md`
...
`rag,agents,automl,vector-stores`
...
- Substituir e/ou complementar o `deployment.yaml` com os manifests reais (Deployments, CRDs, Helm charts, Argo Applications, etc.) que implementam o módulo **M10**, mantendo os labels e o padrão de namespace.
