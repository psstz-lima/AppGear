# GitOps – M10 (m10-brain)

Este diretório contém a camada GitOps/Kustomize para o módulo **M10** da AppGear.
...
- Adicionar aqui os manifests reais (Deployments, Services, CRDs, etc.) que implementam o módulo **M10**, referenciando-os em `kustomization.yaml`.
