...
Este diretório contém a camada GitOps/Kustomize para o módulo **M02** da AppGear (v0.3).
...
`traefik,coraza,kong,istio,tailscale`
...
- Substituir e/ou complementar o `deployment.yaml` com os manifests reais (Deployments, CRDs, Helm charts, Argo Applications, etc.) que implementam o módulo **M02**, mantendo os labels e o padrão de namespace.
