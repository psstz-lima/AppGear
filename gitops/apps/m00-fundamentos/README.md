# GitOps – M00 (m00-fundamentos)

Este diretório contém a camada GitOps/Kustomize para o módulo **M00** da AppGear.
...
- Adicionar aqui os manifests reais (Deployments, Services, CRDs, etc.) que implementam o módulo **M00**, referenciando-os em `kustomization.yaml`.
