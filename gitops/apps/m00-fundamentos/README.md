# GitOps – M00 (fundamentos)

Este diretório contém a camada GitOps/Kustomize para o módulo **M00** da AppGear (v0.3).

- Namespace alvo: `appgear-core`
- Documento normativo do módulo: `development/v0.3/core-module-v0.3.md`
...
`contract,audit,interoperability,stack-unificada`
...
- Substituir e/ou complementar o `deployment.yaml` com os manifests reais (Deployments, CRDs, Helm charts, Argo Applications, etc.) que implementam o módulo **M00**, mantendo os labels e o padrão de namespace.
