# GitOps – M09 (suite-factory)

Este diretório contém a camada GitOps/Kustomize para o módulo **M09** da AppGear (v0.3).
...
`cde,builder,multiplayer,templates`
...
- Substituir e/ou complementar o `deployment.yaml` com os manifests reais (Deployments, CRDs, Helm charts, Argo Applications, etc.) que implementam o módulo **M09**, mantendo os labels e o padrão de namespace.
