# GitOps – M04 (m04-bancos-core)

Este diretório contém a camada GitOps/Kustomize para o módulo **M04** da AppGear.
...
- Adicionar aqui os manifests reais (Deployments, Services, CRDs, etc.) que implementam o módulo **M04**, referenciando-os em `kustomization.yaml`.
